        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 500px; text-align: center;">
                <div class="modal-header" style="border-bottom: none; justify-content: center;">
                    <h2 style="color: var(--green);">🎉 Опрос создан!</h2>
                </div>
                <div class="modal-body">
                    <div style="font-size: 60px; margin-bottom: 20px;">📋</div>
                    <p id="survey-created-title" style="font-size: 18px; font-weight: 600; margin-bottom: 20px;"></p>
                    ...
                    <div style="background: var(--bg-dark); border: 1px solid var(--border); border-radius: 10px; padding: 12px; display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                        <input type="text" id="survey-link-input" readonly style="flex: 1; background: none; border: none; color: var(--text); font-size: 13px; outline: none;">
                        <button onclick="copySurveyLinkFromModal()" style="background: var(--gold); color: #000; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer; font-weight: 600; font-size: 12px;">📋 Копировать</button>
                    </div>
                    
                    <p style="color: var(--text-muted); margin-bottom: 15px;">Поделитесь опросом:</p>
                    
                    <div style="display: flex; gap: 15px; justify-content: center; margin-bottom: 25px;">
                        <button onclick="shareSurveyTo('telegram')" style="width: 60px; height: 60px; border-radius: 15px; border: none; cursor: pointer; font-size: 28px; background: #0088cc; display: flex; align-items: center; justify-content: center;" title="Telegram">
                        ...
                        <button onclick="shareSurveyTo('whatsapp')" style="width: 60px; height: 60px; border-radius: 15px; border: none; cursor: pointer; font-size: 28px; background: #25D366; display: flex; align-items: center; justify-content: center;" title="WhatsApp">
                        ...
                        <button onclick="shareSurveyTo('viber')" style="width: 60px; height: 60px; border-radius: 15px; border: none; cursor: pointer; font-size: 28px; background: #665CAC; display: flex; align-items: center; justify-content: center;" title="Viber">
                        ...
                        <button onclick="shareSurveyTo('email')" style="width: 60px; height: 60px; border-radius: 15px; border: none; cursor: pointer; font-size: 28px; background: var(--bg-lighter); border: 1px solid var(--border); display: flex; align-items: center; justify-content: center;" title="Email">
                            📧
                        </button>
                    </div>
                    
                    <button onclick="closeSurveyCreatedModal()" class="btn btn-gray" style="width: 100%;">Закрыть</button>
                </div>
            </div>
        `;
        document.body.appendChild(modal);
